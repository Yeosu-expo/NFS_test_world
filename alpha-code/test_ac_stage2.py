...
def main():
    ...
    ds_config_path = "/home/deepspeed/config/ds_config_ac_stage2.json"
    ...
    # # (필수) 학습 모드 유지
    # model.train()
    # # (한 줄) 모든 Transformer 블록에 gradient-checkpointing 적용
    # #   * use_reentrant=False → torch.compile, TorchDynamo와 호환
