...
def main():
    ...
    ds_config_path = "/home/deepspeed/config/ds_config_stage2.json"
    ...
    if deepspeed.checkpointing.is_configured():
        logger.info("Checkpointing is configured.")
    else:
        logger.info("Checkpointing is not configured.")
